...
$sql = "INSERT INTO ".$TbName." (firstname, lastname, sex, address, phone, email, password, licensePlate, vahicle)
VALUES ('".$name."', '".$surname."', '".$sex."', '".$address."', '".$phone."', '".$email."','".$password."','".$licensePlate."','".$vahicle."')";
